...
object SeedData {
    ...
    fun cargar(db: SQLiteDatabase) {
        ...
        insertarReceta(db, "Arroz con pollo", "pollo, arroz, cebolla",
            ...
            25, 1.80, "", "https://www.youtube.com/results?search_query=receta+arroz+con+pollo")
        insertarReceta(db, "Tortilla de huevo", "huevo, sal",
            "1. Bate los huevos con sal.\n2. Cocina en sarten hasta dorar.",
            10, 0.90, "", "https://www.youtube.com/results?search_query=receta+tortilla+de+huevo")
        insertarReceta(db, "Sopa de pollo", "pollo, fideos, cebolla, sal",
            "1. Hierve el pollo.\n2. Agrega fideos y cebolla.\n3. Sazona al gusto.",
            30, 2.40, "", "https://www.youtube.com/results?search_query=receta+sopa+de+pollo")
        ...
        insertarReceta(db, "Panqueques", "huevo, harina, leche, azucar",
            ...
            15, 1.50, "", "https://www.youtube.com/results?search_query=receta+panqueques+faciles")
        insertarReceta(db, "Ceviche de camarones", "camarones, limon, cebolla, cilantro, sal",
            ...
            20, 4.50, "", "https://www.youtube.com/results?search_query=receta+ceviche+de+camarones")
        insertarReceta(db, "Pasta con salsa de tomate", "pasta, tomate, ajo, aceite, sal",
            ...
            20, 2.00, "", "https://www.youtube.com/results?search_query=receta+pasta+salsa+tomate")
        insertarReceta(db, "Sandwich de pollo", "pan, pollo, lechuga, tomate, mayonesa",
            ...
            10, 2.50, "", "https://www.youtube.com/results?search_query=receta+sandwich+de+pollo")
    }

    private fun insertarUsuario(db: SQLiteDatabase, nombre: String, correo: String, clave: String, rol: String) {
